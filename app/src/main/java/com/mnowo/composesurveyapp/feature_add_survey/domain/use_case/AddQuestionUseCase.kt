...
class AddQuestionUseCase @Inject constructor(
    ...
    operator fun invoke(surveyQuestion: SurveyQuestion): Flow<Resource<SurveyQuestionResult>> =
        flow {
            ...
            if (titleResult.isValidInput == true) {
                ...
                for (i in 0..3) {
                    when (i) {
                        0 -> {
                            ...
                            val questionOneResult =
                                ValidationUtil.validateText(surveyQuestion.questionOne.toString())
                        ...
                        1 -> {
                            ...
                            val questionTwoResult =
                                ValidationUtil.validateText(surveyQuestion.questionTwo.toString())
                        ...
                        2 -> {
                            ...
                            val questionThreeResult =
                                ValidationUtil.validateText(surveyQuestion.questionThree.toString())
                        ...
                        3 -> {
                            ...
                            val questionFourResult =
                                ValidationUtil.validateText(surveyQuestion.questionFour.toString())
                ...
                if (questionAmount >= 2) {
                    ...
                    emit(
                        Resource.Error<SurveyQuestionResult>(
                            data = SurveyQuestionResult(
                                lessThanTwoFilledAnswerOptions = true
                ...
                emit(
                    Resource.Error<SurveyQuestionResult>(
                        data = SurveyQuestionResult(titleError = true),
                        message = "Empty question title"
                    )
                )
            }
        }
